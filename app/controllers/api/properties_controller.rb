module Api
  class PropertiesController < ApplicationController
    ...
    def destroy
      ...
      if property && (property.user == user)
        property.bookings.clear
        property.destroy
        render json: {
          success: true
        }
    ...
    def property_params
      params.require(:property).permit(:title, :description, :city, :country, :property_type, :price_per_night, :pets, :max_guests, :bedrooms, :beds, :baths, :user_id, images: [])
    end
  end
end